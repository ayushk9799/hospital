...
const LabReportPDF = React.forwardRef(({ reportData, patientData, hospital }, ref) => {
      ...
      <div className="patient-details">
        ...
        <div className="patient-column">
          <div className="patient-info">
            ...
            <span className="patient-value">{patientData?.patient?.gender}</span>
          </div>
          <div className="patient-info">
            <span className="patient-label">Reg No:</span>
            <span className="patient-value">{patientData?.registrationNumber}</span>
          </div>
        </div>
        <div className="patient-column">
          <div className="patient-info">
            <span className="patient-label">Contact:</span>
            <span className="patient-value">{patientData?.contactNumber}</span>
          </div>
          <div className="patient-info">

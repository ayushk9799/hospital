...
const OPDProcedureDialog = ({ open, onOpenChange }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     dispatch(createOPDProcedure(formData)).unwrap().then((res)=>{
      toast({
        title: "Success",
        ...
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="col-span-1">
              <Select value={formData.gender} onValueChange={handleGenderSelect}>
          ...
          <div className="space-y-2">
            <Select value={formData.procedureName} onValueChange={handleProcedureSelect}>
          ...
          <div className="space-y-2">
            ...
            <div className={formData.paymentMethod.length > 0 ? "grid grid-cols-3 gap-2" : "grid grid-cols-2 gap-2"}>
            <div>
              <MultiSelectInput
                suggestions={[
                  { name: "Cash" },
              ...
              {formData.paymentMethod.map((pm) => (
                <MemoizedInput
                  ...
                  value={pm.amount}
                  onChange={(e) => handleAmountPaidChange(pm.method, e.target.value)}

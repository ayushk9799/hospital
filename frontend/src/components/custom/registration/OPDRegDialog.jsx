...
export default function OPDRegDialog({ open, onOpenChange }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      console.log("Form submitted:", { ...formData, reasonForVisit });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[1200px]">
        <DialogHeader>
          <DialogTitle>Register New OPD Patient</DialogTitle>
          <DialogDescription>
            Fill basic details of patient for new OPD registration
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
               ...
               <CustomInput setReasons={setReasonForVisit} reasons={reasonForVisit} />
              </div>

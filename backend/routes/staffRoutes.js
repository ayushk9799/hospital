  ...
  async (req, res) => {
    ...
    try {
      ...
      if (staffData.department) {
        const departments = Array.isArray(staffData.department)
...
router.put("/:id", verifyToken, async (req, res) => {
  ...
  try {
    ...
    // Create a copy of request body to avoid modifying the original
    ...
    if (updateData.department && Array.isArray(updateData.department)) {
      ...
      for (const oldDep of oldStaff.department) {
        if (!updateData.department.includes(oldDep)) {
      ...
      for (const newDep of updateData.department) {
